...
def diag_Problem(domain, Re, Pe, Td):

  # Create Problem
  problem = de.IVP(domain, variables=['p','u','v','ux','vx','uy','vy','r','rx','ry','rd','rdx','rdy'])
  ...
  problem.add_equation("dt(rd)        - vu*(dx(rdx) + dy(rdy)) = 0")
